...
function findGoobjOffset(fd, fileSize) {
  ...
  if (fs.readSync(fd, magicBuf, 0, 8, 0) < 8)
    return -1;
  ...
  while (pos + 60 <= fileSize) {
    if (fs.readSync(fd, hdrBuf, 0, 60, pos) < 60)
      return -1;
