...
var require_dispatcher = __commonJS({
  "node_modules/.pnpm/undici@6.28.0/node_modules/undici/lib/dispatcher/dispatcher.js"(exports2, module2) {
    ...
    var ComposedDispatcher = class extends Dispatcher {
      ...
      close(...args2) {
        return this.#dispatcher.close(...args2);
      }
      destroy(...args2) {
        return this.#dispatcher.destroy(...args2);
      }
    };
...
var require_decorator_handler = __commonJS({
  "node_modules/.pnpm/undici@6.28.0/node_modules/undici/lib/handler/decorator-handler.js"(exports2, module2) {
    ...
    module2.exports = class DecoratorHandler {
      ...
      onResponseStarted(...args2) {
        return this.#handler.onResponseStarted?.(...args2);
      }
      onHeaders(...args2) {
...
// dist/changed.js
var require_changed = __commonJS({
  "dist/changed.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.baseOf = baseOf;
    exports2.changedFiles = changedFiles;
    exports2.scopeOf = scopeOf;
    exports2.currentEvent = currentEvent;
    var node_child_process_1 = require("node:child_process");
    var node_fs_12 = require("node:fs");
    ...
    function changedFiles(base, git = runGit) {
      let rev = base;
    ...
    function scopeOf(event, git = runGit) {
    ...
    function currentEvent() {
      ...
      try {
        return { name, payload: JSON.parse((0, node_fs_12.readFileSync)(path, "utf-8")) };
      } catch {
        return { name, payload: null };
      }
    }
    function runGit(args2) {
      return (0, node_child_process_1.execFileSync)("git", args2, { encoding: "utf-8", stdio: ["ignore", "pipe", "pipe"] });
    }
  }
});
...
var require_guard = __commonJS({
  "dist/guard.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.MARKERS = void 0;
    exports2.workflowPath = workflowPath;
    exports2.neuteredSteps = neuteredSteps;
    ...
    exports2.MARKERS = ["ste-lint", "common-checks"];
    function neuteredSteps(workflow, markers = exports2.MARKERS) {
    ...
    function guard(env) {
      ...
      let workflow;
      try {
        workflow = (0, node_fs_12.readFileSync)((0, node_path_1.join)(env.workspace, path), "utf-8");
      } catch (err) {
      ...
      if (neutered.length) {
        return {
          notes,
          unknown,
          failure: `ste-lint runs under continue-on-error in ${path}: ${neutered.join(", ")}. A step allowed to fail is not a gate. Remove continue-on-error, or remove the step and say so out loud.`
        };
      }
      return { notes, unknown };
    }
...
var require_inputs = __commonJS({
  "dist/inputs.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.STE_MAX_WORDS = void 0;
    exports2.capped = capped;
    exports2.STE_MAX_WORDS = 25;
    function capped(name, raw, fallback, ceiling = exports2.STE_MAX_WORDS) {
      const text = raw.trim();
      if (text === "")
        return fallback;
      const n = Number(text);
      ...
      if (n > ceiling) {
        throw new Error(`${name}=${n} is above ASD-STE100's own cap of ${ceiling}. That does not configure the rule, it removes it. A smaller number is a stricter house style and is accepted.`);
      }
      return n;
    }
  }
...
var require_blocks = __commonJS({
  "dist/blocks.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.isSkippableLine = isSkippableLine;
    exports2.isListLine = isListLine;
    exports2.stripMarkup = stripMarkup;
    exports2.lineAt = lineAt;
    ...
    function stripMarkup(line) {
      return line.replace(LIST_MARKER_RE, "").replace(/\[([^\]]*)\]\([^)]*\)/g, "$1").replace(/[*_]{1,3}/g, "").trim();
    }
...
// dist/ste100-banned-words.js
var require_ste100_banned_words = __commonJS({
  "dist/ste100-banned-words.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.BANNED_WORDS = void 0;
    exports2.BANNED_WORDS = {
      "abandon": ["GO", "STOP"],
      "abate": ["DECREASE"],
      "ability": ["CAN"],
      "able": ["CAN"],
...
var require_lint = __commonJS({
  "dist/lint.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.DEFAULTS = exports2.stripMarkup = exports2.lineAt = exports2.isSkippableLine = exports2.isListLine = exports2.blocks = void 0;
    exports2.emptyFindings = emptyFindings;
    exports2.hasFailures = hasFailures;
    exports2.isClause = isClause;
    exports2.clauseBefore = clauseBefore;
    exports2.blankSpan = blankSpan;
    exports2.stripCode = stripCode;
    exports2.stripQuotedSpans = stripQuotedSpans;
    exports2.sentences = sentences;
    exports2.wordCount = wordCount;
    exports2.nounRuns = nounRuns;
    exports2.lintText = lintText;
    exports2.lintFiles = lintFiles;
    exports2.failureReport = failureReport;
    var blocks_1 = require_blocks();
    Object.defineProperty(exports2, "blocks", { enumerable: true, get: function() {
      return blocks_1.blocks;
    } });
    Object.defineProperty(exports2, "isListLine", { enumerable: true, get: function() {
      return blocks_1.isListLine;
    } });
    Object.defineProperty(exports2, "isSkippableLine", { enumerable: true, get: function() {
      return blocks_1.isSkippableLine;
    } });
    Object.defineProperty(exports2, "lineAt", { enumerable: true, get: function() {
      return blocks_1.lineAt;
    } });
    Object.defineProperty(exports2, "stripMarkup", { enumerable: true, get: function() {
      return blocks_1.stripMarkup;
    } });
    var ste100_banned_words_1 = require_ste100_banned_words();
    exports2.DEFAULTS = { hardMaxWords: 25, warnMaxWords: 20 };
    ...
    function hasFailures(f) {
      return f.hardLong.length > 0 || f.contractions.length > 0 || f.bannedModals.length > 0 || f.semicolons.length > 0 || f.commaSplices.length > 0 || f.wrappedLines.length > 0;
    }
    var CONTRACTION_RE = /\b(?:can't|won't|don't|doesn't|didn't|isn't|aren't|wasn't|weren't|wouldn't|shouldn't|couldn't|mustn't|hasn't|haven't|hadn't|it's|that's|there's|here's|let's|we're|they're|you're|i'm|i've|we've|they've|you've|i'll|we'll|they'll|you'll|he's|she's|who's|what's)\b/gi;
    var BANNED_MODAL_RE = /\b(should|shall|could|might|would)\b/gi;
    var SEMICOLON_RE = /;/g;
    var CLAUSE_SUBJECT = "it|they|he|she|we|you|this|that|these|those|nothing|everything|nobody|the|a|an";
    var FINITE_VERB = "is|are|was|were|has|have|had|does|do|did|can|cannot|must|will|makes|make|means|gives|gets|goes|comes|stays|keeps|needs|wants|says|reads|holds|owns|carries|fires|runs|works|costs|counts|leaves|starts|stops|takes|tells|turns|lives|looks|sits|sends|renders|answers|reports|names|breaks|ends";
    var FINITE_VERB_RE = new RegExp(`\\b(?:${FINITE_VERB})\\b`, "i");
    var COMMA_SPLICE_RE = new RegExp(`,\\s+(?:(?:and|but|so|yet|then)\\s+)?(?:${CLAUSE_SUBJECT})\\s+(?:\\w+\\s+){0,2}?(?:not\\s+)?(?:${FINITE_VERB})\\b`, "gi");
    function isClause(before) {
      const words = before.trim();
      if (SUBORDINATOR_RE.test(words))
        return false;
    ...
    var PARTICIPLE_PATTERN = `(?:[a-z]+ed|${IRREGULAR_PARTICIPLES.join("|")})`;
    var PERFECT_TENSE_RE = new RegExp(`\\b(?:will\\s+have|has|have|had)\\b(?:\\s+(?:not|never|already|just|recently|still))?\\s+(${PARTICIPLE_PATTERN})\\b`, "gi");
    var PROGRESSIVE_EXEMPT = ["mating", "missing", "remaining", "something", "during"];
    var PROGRESSIVE_TENSE_RE = new RegExp(`\\b(?:is|are|was|were|am|been)\\b(?:\\s+not)?\\s+(?!(?:${PROGRESSIVE_EXEMPT.join("|")})\\b)([a-z]+ing)\\b`, "gi");
    var WORD_TOKEN_RE = /[a-z][a-z'-]*/gi;
    var PASSIVE_RE = /\b(?:is|are|was|were|be|been|being)\s+\w+ed\b/gi;
    ...
    var SUBORDINATOR_RE = /^(?:(?:and|but|so|or|yet)\s+)?(?:if|when|whenever|where|wherever|while|because|although|though|unless|since|after|before|until|once|whether|provided|assuming|given|for)\b/i;
    ...
    function lintText(name, text, opts = exports2.DEFAULTS, into = emptyFindings()) {
      ...
      for (const block of (0, blocks_1.blocks)(source)) {
        const { text: joined } = block;
        const at = (index) => `${name}:${(0, blocks_1.lineAt)(block, index)}`;
        ...
        if (!block.list)
          paragraphSentences += sentences(joined).length;
        ...
        while (m = CONTRACTION_RE.exec(joined))
          into.contractions.push(`${at(m.index)}: "${m[0]}"`);
        BANNED_MODAL_RE.lastIndex = 0;
        while (m = BANNED_MODAL_RE.exec(joined))
          into.bannedModals.push(`${at(m.index)}: "${m[0]}"`);
        SEMICOLON_RE.lastIndex = 0;
        while (m = SEMICOLON_RE.exec(joined))
          into.semicolons.push(`${at(m.index)}: ";"`);
        COMMA_SPLICE_RE.lastIndex = 0;
        while (m = COMMA_SPLICE_RE.exec(joined)) {
          if (isClause(clauseBefore(joined, m.index)))
            into.commaSplices.push(`${at(m.index)}: "${m[0].trim()}"`);
        }
        ...
        while (m = PASSIVE_RE.exec(joined))
          into.passive.push(at(m.index));
        for (const run of nounRuns(joined))
          into.nounClusters.push(`${name}:${block.startLine}: "${run}"`);
        WORD_TOKEN_RE.lastIndex = 0;
        let w;
        while (w = WORD_TOKEN_RE.exec(joined)) {
          const key = w[0].toLowerCase();
          const alts = Object.hasOwn(ste100_banned_words_1.BANNED_WORDS, key) ? ste100_banned_words_1.BANNED_WORDS[key] : void 0;
          if (alts)
            into.bannedWords.push(`${at(w.index)}: "${w[0]}" -- use ${alts.join(" or ")}`);
        }
      }
      flushParagraph();
      return into;
    }
    function lintFiles(files, opts = exports2.DEFAULTS) {
      const findings = emptyFindings();
      for (const f of files)
        lintText(f.name, f.text, opts, findings);
      return findings;
    }
    function failureReport(f, opts) {
      const problems = [];
      if (f.hardLong.length) {
        problems.push(`Sentences over ${opts.hardMaxWords} words (STE's own outer bound, for a description; an instruction caps at ${opts.warnMaxWords}):
${f.hardLong.join("\n")}`);
      }
      if (f.contractions.length)
        problems.push(`Contractions are banned in STE:
${f.contractions.join("\n")}`);
      if (f.bannedModals.length) {
        problems.push(`STE bans "should"/"shall"/"could"/"might"/"would" -- use "must"/"must not" for obligation and "can" for ability or possibility:
${f.bannedModals.join("\n")}`);
      }
...
${f.semicolons.join("\n")}`);
      ...
      if (f.commaSplices.length) {
        problems.push(`A comma joining two clauses is the semicolon STE bans, spelled differently -- use a period and start a new sentence:
${f.commaSplices.join("\n")}`);
      }
      if (f.wrappedLines.length) {
        problems.push("A paragraph is one line -- join these back up and let the reader's window do the wrapping:\n" + f.wrappedLines.join("\n"));
      }
...
// dist/submodules.js
var require_submodules = __commonJS({
  "dist/submodules.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.submodulePaths = submodulePaths;
    exports2.inSubmodule = inSubmodule;
    function submodulePaths(text) {
      const paths = [];
      for (const line of text.split("\n")) {
...
// dist/vendored.js
var require_vendored = __commonJS({
  "dist/vendored.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.vendoredPaths = vendoredPaths;
    exports2.setPaths = setPaths;
    var node_child_process_1 = require("node:child_process");
    var ATTRIBUTES = ["linguist-vendored", "linguist-generated"];
    function vendoredPaths(files, run = gitCheckAttr) {
      const vendored = /* @__PURE__ */ new Set();
      if (files.length === 0)
        return vendored;
    ...
    function gitCheckAttr(attribute, files) {
      const out = (0, node_child_process_1.execFileSync)("git", ["check-attr", "--stdin", "-z", attribute], {
        input: files.join("\0"),
        encoding: "utf-8"
      });
      return setPaths(out);
    }
    function setPaths(out) {
...
var changed_1 = require_changed();
var guard_1 = require_guard();
var inputs_1 = require_inputs();
var lint_1 = require_lint();
var submodules_1 = require_submodules();
var vendored_1 = require_vendored();
function gitmodules() {
  try {
    return (0, node_fs_2.readFileSync)(".gitmodules", "utf-8");
  } catch {
    return "";
  }
}
function patternsOf(raw) {
  return raw.split(/[\s,]+/).map((p) => p.trim()).filter(Boolean);
}
function preview(items, limit = 20) {
...
function main() {
  ...
  for (const note of gate.notes)
    core.info(note);
  for (const u of gate.unknown)
    core.error(`ste-lint could not establish ${u}`);
  if (gate.failure) {
  ...
  const opts = {
    hardMaxWords: (0, inputs_1.capped)("hard-max-words", core.getInput("hard-max-words"), lint_1.DEFAULTS.hardMaxWords, inputs_1.STE_MAX_WORDS),
    warnMaxWords: (0, inputs_1.capped)("warn-max-words", core.getInput("warn-max-words"), lint_1.DEFAULTS.warnMaxWords, inputs_1.STE_MAX_WORDS)
  };
  ...
  const matched = [...new Set(patterns.flatMap((p) => (0, node_fs_1.globSync)(p, { exclude: (n) => n.includes("node_modules") })))].sort();
  if (matched.length === 0) {
    core.setFailed(`ste-lint matched no files: ${patterns.join(" ")}. A check that reads nothing passes for the wrong reason.`);
    return;
  }
  const submodules = (0, submodules_1.submodulePaths)(gitmodules());
  const skip = (0, submodules_1.inSubmodule)(submodules);
  const ours = matched.filter((name) => !skip(name));
  if (submodules.length)
    core.info(`ste-lint: ${matched.length - ours.length} file(s) belong to a submodule: ${submodules.join(" ")}`);
  const vendored = (0, vendored_1.vendoredPaths)(ours);
  const theirs = ours.filter((name) => !vendored.has(name));
  if (vendored.size)
    core.info(`ste-lint: ${ours.length - theirs.length} file(s) are marked linguist-vendored or linguist-generated`);
  if (theirs.length === 0) {
    core.setFailed(`ste-lint read none of the ${matched.length} file(s) that ${patterns.join(" ")} matched: every one belongs to another repository. A check that reads nothing passes for the wrong reason.`);
    return;
  }
  const scope = (0, changed_1.scopeOf)((0, changed_1.currentEvent)());
  ...
  const findings = (0, lint_1.lintFiles)(names.map((name) => ({ name, text: (0, node_fs_2.readFileSync)(name, "utf-8") })), opts);
  core.setOutput("files", names.length);
  core.setOutput("violations", findings.hardLong.length + findings.contractions.length + findings.bannedModals.length + findings.semicolons.length + findings.commaSplices.length + findings.wrappedLines.length);
  if ((0, lint_1.hasFailures)(findings)) {
    core.setFailed("STE-style lint failed -- mechanical subset only, NOT full ASD-STE100 conformance (several writing rules need real semantic judgment a pattern cannot do; see docs/ste-lint-spec-mapping.md):\n\n" + (0, lint_1.failureReport)(findings, opts));
  }
  if (findings.warnLong.length) {
    core.warning(`Sentences over ${opts.warnMaxWords} words, under the ${opts.hardMaxWords}-word hard cap (an instruction stays at or under ${opts.warnMaxWords}; a description may run to ${opts.hardMaxWords}) (${findings.warnLong.length} found): ${preview(findings.warnLong)}`);
  }
  ...
  if (findings.nounClusters.length) {
    core.warning(`Possible long noun cluster, heuristic only, not enforced (${findings.nounClusters.length} found): ${preview(findings.nounClusters)}`);
  }
  if (findings.complexTense.length) {
    core.warning(`Possible complex verb tense (STE allows only simple tenses), heuristic only, not enforced (${findings.complexTense.length} found): ${preview(findings.complexTense)}`);
  }
  if (findings.bannedWords.length) {
    core.warning(`Word not approved in the ASD-STE100 dictionary, heuristic only, not enforced -- this checker matches text, not part of speech or meaning, so it can miss a word's approved sense (${findings.bannedWords.length} found): ${preview(findings.bannedWords)}`);
  }
  if (findings.longParagraphs.length) {
    core.warning(`Paragraph over 6 sentences, heuristic only, not enforced (${findings.longParagraphs.length} found): ${preview(findings.longParagraphs)}`);
  }
}
function cli(patterns) {
  const opts = { ...lint_1.DEFAULTS };
  const skip = (0, submodules_1.inSubmodule)((0, submodules_1.submodulePaths)(gitmodules()));
  const ours = [...new Set(patterns.flatMap((p) => (0, node_fs_1.globSync)(p, { exclude: (n) => n.includes("node_modules") })))].sort().filter((name) => !skip(name));
  const vendored = (0, vendored_1.vendoredPaths)(ours);
