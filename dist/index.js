...
var require_lint = __commonJS({
  "dist/lint.js"(exports2) {
    ...
    function hasFailures(f) {
      return f.hardLong.length > 0 || f.contractions.length > 0 || f.bannedModals.length > 0 || f.semicolons.length > 0 || f.commaSplices.length > 0;
    }
...
function main() {
  ...
  core.setOutput("violations", findings.hardLong.length + findings.contractions.length + findings.bannedModals.length + findings.semicolons.length);
