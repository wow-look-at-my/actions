...
(0, node_test_1.test)('the common-checks step that calls this action counts as this step', () => {
...
`;
    const found = (0, guard_1.neuteredSteps)(wrapped);
    strict_1.default.equal(found.length, 1);
    strict_1.default.match(found[0], /uses: wow-look-at-my\/actions@common-checks#latest/);
});
