...
Today that is [yaml-comment-block](../yaml-comment-block/). A check added here reaches every caller on the next run of `common-checks`, with no edit to their workflow.
